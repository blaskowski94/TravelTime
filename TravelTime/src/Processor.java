...
public class Processor extends Thread {
	public BlockingQueue<TravelData>	h2wQ			= new ArrayBlockingQueue<>(10);
	public BlockingQueue<TravelData>	w2hQ			= new ArrayBlockingQueue<>(10);
	 ...
	 */
	public TimeData[] calculateTime(String addr1, String addr2) throws Exception {
		TimeData[] retVal = new TimeData[2];
		TimeData t1, t2;
		String returnedTime1 = null, returnedTime2 = null;
		String[] splitString1 = null, splitString2 = null;
		...
		try {
			...
			GUI.updateErrorMessage("Invalid address");
	...
	public static void setTimeInterval(int seconds) {
